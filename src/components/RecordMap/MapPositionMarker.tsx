...
function MapPositionMarker({ fill, label, fontColor }: MapPositionMarkerProps) {
  return (
    <svg width={36} height={36} viewBox='0 0 24 24' fill={fill} xmlns='http://www.w3.org/2000/svg'>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        ...
        strokeWidth={3}
      />
      <circle cx='12' cy='11' r='6' fill={fill} />
      <text x='12' y='12' textAnchor='middle' dominantBaseline='middle' fontWeight={500} fontSize={6} fill={fontColor}>
        {label}
      </text>
    </svg>
  );
...
export default MapPositionMarker;
